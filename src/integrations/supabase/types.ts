...
export type Database = {
  ...
  public: {
    Tables: {
      announcements: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "announcements_user_id_profiles_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      discussion_posts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "discussion_posts_user_id_profiles_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["user_id"]
    ...
    Functions: {
      ...
      link_parent_to_child: { Args: { child_email: string }; Returns: Json }
    }
    Enums: {
      app_role: "admin" | "instructor" | "student" | "parent"
    }
    CompositeTypes: {
      [_ in never]: never
    }
