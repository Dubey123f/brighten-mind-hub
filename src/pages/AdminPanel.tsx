...
import { Users, Shield, BookOpen, GraduationCap, Search, UserPlus, Trash2, Edit } from "lucide-react";
...
export default function AdminPanel() {
  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-6">Manage users, roles, and platform settings</p>
